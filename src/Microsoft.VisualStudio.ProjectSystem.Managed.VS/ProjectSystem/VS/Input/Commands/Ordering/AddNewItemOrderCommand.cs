...
namespace Microsoft.VisualStudio.ProjectSystem.VS.Input.Commands.Ordering
{
    ...
    internal class AddNewItemOrderCommand : AbstractAddChildItemCommand
    {
        ...
        public AddNewItemOrderCommand(IPhysicalProjectTree projectTree, IUnconfiguredProjectVsServices projectVsServices, SVsServiceProvider serviceProvider) : base(projectTree, projectVsServices, serviceProvider)
        {
        }
        ...
        {
            return AddItemHelper.ShowAddNewItemDialogAsync(projectTree, projectVsServices, serviceProvider, node, browseLocations);
        }
    }
}
