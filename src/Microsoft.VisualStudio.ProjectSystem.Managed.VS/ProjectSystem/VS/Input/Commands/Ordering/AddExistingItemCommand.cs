...
namespace Microsoft.VisualStudio.ProjectSystem.VS.Input.Commands.Ordering
{
    ...
    internal class AddExistingItemOrderCommand : AbstractAddChildCommand
    {
        ...
        public AddExistingItemOrderCommand(IPhysicalProjectTree projectTree, ConfiguredProject configuredProject, IProjectTreeVsOperations operations) : base(projectTree, configuredProject, operations)
        {
        }

        protected override Task AddNode(IProjectTreeVsOperations operations, IProjectTree target)
        {
            return operations.ShowAddExistingFilesDialogAsync(target);
        }
