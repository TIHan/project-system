...
namespace Microsoft.VisualStudio.ProjectSystem.VS.Input.Commands.Ordering
{
    ...
    internal class AddNewItemBelowCommand : AbstractAddSiblingCommand
    {
        ...
        public AddNewItemBelowCommand(IPhysicalProjectTree projectTree, ConfiguredProject configuredProject, IProjectTreeVsOperations operations) : base(projectTree, configuredProject, operations)
        {
        }
